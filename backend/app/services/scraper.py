...
MAX_PAGES       = int(os.environ.get("SCRAPER_MAX_PAGES",        "20"))   # raised from 5: evaluation showed 15 pages missed pricing/FAQ
...
CRAWL_BUDGET    = int(os.environ.get("SCRAPER_CRAWL_BUDGET",    "50"))   # raised from 25: supports 20 pages
...
# Categories that must be crawled first (before general pages fill the budget).
# Matches crawl_coverage.CATEGORIES keys.
